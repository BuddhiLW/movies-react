...
var and__5041__auto____$1 = (function (){var fexpr__75458 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, ["",null,"_self",null], null), null);
return (fexpr__75458.cljs$core$IFn$_invoke$arity$1 ? fexpr__75458.cljs$core$IFn$_invoke$arity$1(link_target) : fexpr__75458.call(null,link_target));
})();
if(cljs.core.truth_(and__5041__auto____$1)){
 ...
 */
accountant.core.configure_navigation_BANG_ = (function accountant$core$configure_navigation_BANG_(p__75468){
var map__75469 = p__75468;
var map__75469__$1 = cljs.core.__destructure_map(map__75469);
var nav_handler = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__75469__$1,new cljs.core.Keyword(null,"nav-handler","nav-handler",2039495484));
var path_exists_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__75469__$1,new cljs.core.Keyword(null,"path-exists?","path-exists?",1473384514));
var reload_same_path_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__75469__$1,new cljs.core.Keyword(null,"reload-same-path?","reload-same-path?",1981904231));
...
var seq__75476 = cljs.core.seq(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [accountant.core.document_click_handler_listener_key,accountant.core.navigate_listener_key], null));
var chunk__75477 = null;
var count__75478 = (0);
var i__75479 = (0);
while(true){
if((i__75479 < count__75478)){
var key = chunk__75477.cljs$core$IIndexed$_nth$arity$2(null,i__75479);
...
var G__75508 = seq__75476;
var G__75509 = chunk__75477;
var G__75510 = count__75478;
var G__75511 = (i__75479 + (1));
seq__75476 = G__75508;
chunk__75477 = G__75509;
count__75478 = G__75510;
i__75479 = G__75511;
continue;
} else {
var temp__5804__auto__ = cljs.core.seq(seq__75476);
if(temp__5804__auto__){
var seq__75476__$1 = temp__5804__auto__;
if(cljs.core.chunked_seq_QMARK_(seq__75476__$1)){
var c__5565__auto__ = cljs.core.chunk_first(seq__75476__$1);
var G__75512 = cljs.core.chunk_rest(seq__75476__$1);
var G__75513 = c__5565__auto__;
var G__75514 = cljs.core.count(c__5565__auto__);
var G__75515 = (0);
seq__75476 = G__75512;
chunk__75477 = G__75513;
count__75478 = G__75514;
i__75479 = G__75515;
continue;
} else {
var key = cljs.core.first(seq__75476__$1);
if(cljs.core.truth_(key)){
goog.events.unlistenByKey(key);
} else {
}
...
var G__75516 = cljs.core.next(seq__75476__$1);
var G__75517 = null;
var G__75518 = (0);
var G__75519 = (0);
seq__75476 = G__75516;
chunk__75477 = G__75517;
count__75478 = G__75518;
i__75479 = G__75519;
continue;
}
} else {
...
var params = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__75489_SHARP_){
return cljs.core.name(p1__75489_SHARP_);
...
return clojure.string.join.cljs$core$IFn$_invoke$arity$2("&",cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__75490_SHARP_){
return clojure.string.join.cljs$core$IFn$_invoke$arity$2("=",p1__75490_SHARP_);
}),pairs));
});
/**
...
if(cljs.core.truth_(accountant.core.nav_handler)){
var G__75496 = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(path),cljs.core.str.cljs$core$IFn$_invoke$arity$1(query),cljs.core.str.cljs$core$IFn$_invoke$arity$1(hash)].join('');
return (accountant.core.nav_handler.cljs$core$IFn$_invoke$arity$1 ? accountant.core.nav_handler.cljs$core$IFn$_invoke$arity$1(G__75496) : accountant.core.nav_handler.call(null,G__75496));
} else {
