...
var G__65191 = devtools.prefs.pref(v);
v = G__65191;
continue;
} else {
return v;
...
}catch (e65127){var _e__64230__auto__ = e65127;
return false;
}})();
...
}catch (e65129){var _e__64230__auto__ = e65129;
return false;
}})();
...
}catch (e65132){var _e__64230__auto__ = e65132;
return false;
}}
}
});
...
var vec__65140 = devtools.munging.parse_constructor_info(constructor_fn);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65140,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65140,(1),null);
...
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(devtools.formatters.helpers.pref(new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__65158_SHARP_);
}),template);
});
