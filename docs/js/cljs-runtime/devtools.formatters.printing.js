...
var len__5766__auto___65265 = arguments.length;
var i__5767__auto___65266 = (0);
while(true){
if((i__5767__auto___65266 < len__5766__auto___65265)){
args__5772__auto__.push((arguments[i__5767__auto___65266]));

var G__65267 = (i__5767__auto___65266 + (1));
i__5767__auto___65266 = G__65267;
continue;
} else {
}
break;
...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq65201){
...
return self__5751__auto__.cljs$core$IFn$_invoke$arity$variadic(G__65202,G__65203,seq65201__$2);
}));
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_(new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__65236_SHARP_){
return (!((cljs.core.meta(p1__65236_SHARP_) == null)));
})))){
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65244__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e65245){var _e__64230__auto__ = e65245;
return false;
}})();
if(cljs.core.truth_(or__5043__auto__)){
return or__5043__auto__;
...
}catch (e65247){var _e__64230__auto__ = e65247;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__65252 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__65253 = devtools.formatters.state.get_current_state();
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__65253);
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65257__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__65252);
}});
...
var temp__5802__auto___65280 = devtools.formatters.state.get_managed_print_level();
if(cljs.core.truth_(temp__5802__auto___65280)){
var managed_print_level_65281 = temp__5802__auto___65280;
var _STAR_print_level_STAR__orig_val__65259_65283 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__65260_65284 = managed_print_level_65281;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__65260_65284);

try{devtools.formatters.state.update_current_state_BANG_((function (p1__65258_SHARP_){
return devtools.formatters.state.set_managed_print_level(p1__65258_SHARP_,null);
}));

job_fn();
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__65259_65283);
}} else {
job_fn();
}
