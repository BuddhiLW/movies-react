...
var G__75055 = o;
reagent.impl.template.goog$module$goog$object.set(G__75055,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
return (function() { 
var G__75134__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
var G__75134 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__75135__i = 0, G__75135__a = new Array(arguments.length -  0);
while (G__75135__i < G__75135__a.length) {G__75135__a[G__75135__i] = arguments[G__75135__i + 0]; ++G__75135__i;}
  args = new cljs.core.IndexedSeq(G__75135__a,0,null);
} 
return G__75134__delegate.call(this,args);};
G__75134.cljs$lang$maxFixedArity = 0;
G__75134.cljs$lang$applyTo = (function (arglist__75136){
var args = cljs.core.seq(arglist__75136);
return G__75134__delegate(args);
});
...
var G__75061 = o;
reagent.impl.template.goog$module$goog$object.set(G__75061,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
if(cljs.core.ifn_QMARK_(x)){
return (function() { 
var G__75138__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
var G__75138 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__75139__i = 0, G__75139__a = new Array(arguments.length -  0);
while (G__75139__i < G__75139__a.length) {G__75139__a[G__75139__i] = arguments[G__75139__i + 0]; ++G__75139__i;}
  args = new cljs.core.IndexedSeq(G__75139__a,0,null);
} 
return G__75138__delegate.call(this,args);};
G__75138.cljs$lang$maxFixedArity = 0;
G__75138.cljs$lang$applyTo = (function (arglist__75140){
var args = cljs.core.seq(arglist__75140);
return G__75138__delegate(args);
});
...
var G__75064 = props;
var G__75064__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__75064,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__75064);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__75064__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__5043__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__75065 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__75065,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__75065;
}
})(),id_class);
...
var G__75067 = (cljs.core.count(argv) - first_child);
switch (G__75067) {
case (0):
...
var vec__75072 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__75072,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__75072,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__75072,(2),null);
...
var temp__5808__auto___75156 = reagent.impl.util.react_key_from_vec(v);
if((temp__5808__auto___75156 == null)){
} else {
var key_75157 = temp__5808__auto___75156;
(jsprops.key = key_75157);
}
...
var temp__5808__auto___75165 = reagent.impl.util.react_key_from_vec(v);
if((temp__5808__auto___75165 == null)){
} else {
var key_75167 = temp__5808__auto___75165;
(jsprops.key = key_75167);
}
...
var temp__5808__auto___75168 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5808__auto___75168 == null)){
} else {
var key_75169 = temp__5808__auto___75168;
(jsprops.key = key_75169);
}
...
var temp__5808__auto___75177 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5808__auto___75177 == null)){
} else {
var key_75178 = temp__5808__auto___75177;
(jsprops.key = key_75178);
}
...
var temp__5808__auto___75179 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5808__auto___75179 == null)){
} else {
var key_75180 = temp__5808__auto___75179;
(jsprops.key = key_75180);
}
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__75105_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__75105_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__75106 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__75106,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__75106,(1),null);
...
break;
default:
var G__75200 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
var G__75201 = compiler;
v = G__75200;
compiler = G__75201;
continue;
...
var G__75119 = tag;
var G__75119__$1 = (((G__75119 instanceof cljs.core.Keyword))?G__75119.fqn:null);
switch (G__75119__$1) {
case ">":
...
if((typeof reagent !== 'undefined') && (typeof reagent.impl !== 'undefined') && (typeof reagent.impl.template !== 'undefined') && (typeof reagent.impl.template.t_reagent$impl$template75127 !== 'undefined')){
} else {
...
*/
reagent.impl.template.t_reagent$impl$template75127 = (function (opts,id,fn_to_element,parse_fn,meta75128){
this.opts = opts;
this.id = id;
this.fn_to_element = fn_to_element;
this.parse_fn = parse_fn;
this.meta75128 = meta75128;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(reagent.impl.template.t_reagent$impl$template75127.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_75129,meta75128__$1){
var self__ = this;
var _75129__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template75127(self__.opts,self__.id,self__.fn_to_element,self__.parse_fn,meta75128__$1));
}));

(reagent.impl.template.t_reagent$impl$template75127.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_75129){
var self__ = this;
var _75129__$1 = this;
return self__.meta75128;
}));

(reagent.impl.template.t_reagent$impl$template75127.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template75127.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template75127.prototype.reagent$impl$protocols$Compiler$parse_tag$arity$3 = (function (this$,tag_name,tag_value){
var self__ = this;
var this$__$1 = this;
...
(reagent.impl.template.t_reagent$impl$template75127.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template75127.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template75127.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"parse-fn","parse-fn",-836029424,null),new cljs.core.Symbol(null,"meta75128","meta75128",-1820187030,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template75127.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template75127.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template75127");

(reagent.impl.template.t_reagent$impl$template75127.cljs$lang$ctorPrWriter = (function (this__5327__auto__,writer__5328__auto__,opt__5329__auto__){
return cljs.core._write(writer__5328__auto__,"reagent.impl.template/t_reagent$impl$template75127");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template75127.
 */
reagent.impl.template.__GT_t_reagent$impl$template75127 = (function reagent$impl$template$create_compiler_$___GT_t_reagent$impl$template75127(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta75128){
return (new reagent.impl.template.t_reagent$impl$template75127(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta75128));
});

}

return (new reagent.impl.template.t_reagent$impl$template75127(opts,id,fn_to_element,parse_fn,cljs.core.PersistentArrayMap.EMPTY));
});
