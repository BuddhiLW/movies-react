...
var map__64708 = top_item;
var map__64708__$1 = cljs.core.__destructure_map(map__64708);
var file = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__64708__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__64708__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__64708__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return devtools.hints.make_sense_of_the_error(error.message,file,line,column);
}catch (e64706){var _e = e64706;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__5802__auto___64739 = devtools.hints.get_processed_errors_BANG_();
if(cljs.core.truth_(temp__5802__auto___64739)){
var seen_errors_64740 = temp__5802__auto___64739;
if(cljs.core.truth_(seen_errors_64740.has(self))){
} else {
seen_errors_64740.add(self);

var temp__5804__auto___64741 = devtools.hints.error_object_sense(self);
if(cljs.core.truth_(temp__5804__auto___64741)){
var sense_64742 = temp__5804__auto___64741;
(self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_64742)].join(''));
} else {
}
}
} else {
