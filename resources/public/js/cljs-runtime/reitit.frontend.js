...
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,cljs.core.map.cljs$core$IFn$_invoke$arity$2(cljs.core.juxt.cljs$core$IFn$_invoke$arity$2(cljs.core.keyword,(function (p1__75952_SHARP_){
return reitit.frontend.query_param(q,p1__75952_SHARP_);
})),q.getKeys()));
});
/**
...
(reitit.frontend.match_by_path.cljs$core$IFn$_invoke$arity$3 = (function (router,path,p__75961){
var map__75962 = p__75961;
var map__75962__$1 = cljs.core.__destructure_map(map__75962);
var on_coercion_error = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__75962__$1,new cljs.core.Keyword(null,"on-coercion-error","on-coercion-error",-970787));
...
if(cljs.core.every_QMARK_((function (p1__75973_SHARP_){
return cljs.core.contains_QMARK_(path_params,p1__75973_SHARP_);
